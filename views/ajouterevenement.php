					...
					<header class="topHeadingHead text-center mb-lg-7 mb-xl-9">
						<div class="row">
							<div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
								<h1 class="h1Large mb-4"> Ajouter un évenement</h1>
							</div>
						</div>
					</header>
					<!-- alert -->
...
-->
					<form method="POST" action="../controllers/evenementController.php?a=create" enctype="multipart/form-data">
							...
							<div class="col-12 col-md-6 px-xl-4">
								...
								<div class="form-row mx-n2">
									...
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												<strong class="font-weight-normal d-block mb-1">Affiche de l'évenement<span class="text-brown">*</span></strong>
