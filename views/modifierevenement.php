					...
					<header class="topHeadingHead text-center mb-lg-7 mb-xl-9">
						<div class="row">
							<div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
								<h1 class="h1Large mb-4"> Modifier un évenement</h1>
							</div>
						</div>
					</header>
					<!-- alert -->
...
-->
					<form method="POST" action="../controllers/evenementController.php?a=modifier&id=<?=$id?>">
						<div class="row mx-xl-n4 mt-5 mb-6 mt-md-11 mb-md-10">
							<div class="col-12 col-md-6 px-xl-4">
								<h2 class="mb-5">Information sur l'évenement</h2>
									...
									<div class="col-12 col-sm-12 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="text" value="<?=$e->titre?>" name="titre" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
                                    <div class="col-12 col-sm-12 px-2">
									...
									<div class="col-12 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
                                                ...
                                                <textarea rows="20" name="description" class="form-control formControlMedium rounded-sm d-block w-100"><?=$e->description?></textarea>
											</label>
										</div>
									</div>
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input value="<?=$e->dateDebut?>" type="date" name="dateDebut" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="date" value="<?=$e->dateFin?>" name="dateFin"  class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
