...
<head>
	...
	<title>Dashboard | 55 La PLate Forme</title>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i> 3.65%
										</span>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> -5.25%
										</span>
										<span class="text-muted">Since last week</span>
									</div>
								</div>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i> 4.65%
										</span>
										<span class="text-muted">Since last week</span>
									</div>
								</div>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> -2.35%
										</span>
										<span class="text-muted">Since last week</span>
									</div>
								</div>
								...
								<table class="table table-striped my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-xl-table-cell text-end">Open tickets</th>
									...
									<tbody>
										<tr>
											...
											<td class="d-none d-xl-table-cell text-end">5</td>
											<td class="d-none d-xl-table-cell text-end">520</td>
										</tr>
										<tr>
											<td>Spark Theme</td>
											<td><span class="badge bg-success">HTML</span></td>
											...
											<td class="d-none d-xl-table-cell text-end">240</td>
										</tr>
										<tr>
											<td>Milo Theme</td>
											<td><span class="badge bg-success">HTML</span></td>
											...
											<td class="d-none d-xl-table-cell text-end">180</td>
										</tr>
										<tr>
											<td>Ada Theme</td>
											<td><span class="badge bg-primary">React.js</span></td>
											<td class="d-none d-xl-table-cell">Single license</td>
											<td class="d-none d-xl-table-cell text-end">2</td>
											<td class="d-none d-xl-table-cell text-end">410</td>
										</tr>
										<tr>
											<td>Abel Theme</td>
											<td><span class="badge bg-primary">React.js</span></td>
											...
											<td class="d-none d-xl-table-cell text-end">250</td>
										</tr>
										<tr>
											<td>Spark Theme</td>
											<td><span class="badge bg-success">HTML</span></td>
											<td class="d-none d-xl-table-cell">Single license</td>
											<td class="d-none d-xl-table-cell text-end">12</td>
											<td class="d-none d-xl-table-cell text-end">430</td>
										</tr>
										<tr>
											<td>Libre Theme</td>
											<td><span class="badge bg-success">HTML</span></td>
											<td class="d-none d-xl-table-cell">Single license</td>
											<td class="d-none d-xl-table-cell text-end">18</td>
											<td class="d-none d-xl-table-cell text-end">320</td>
										</tr>
										<tr>
											<td>Von Theme</td>
											<td><span class="badge bg-primary">React.js</span></td>
											<td class="d-none d-xl-table-cell">Single license</td>
											<td class="d-none d-xl-table-cell text-end">2</td>
											<td class="d-none d-xl-table-cell text-end">310</td>
										</tr>
									</tbody>
								</table>
							</div>
