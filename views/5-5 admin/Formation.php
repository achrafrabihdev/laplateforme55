				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Formation" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Formation.php">Liste des
									Formation</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Formations</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success" onclick="window.location.href='Add-Formation.php';">Ajouter Formation
										</button>
											...
											<table class="table table-striped">
												...
												<?php foreach($formations as $f) {
													$u = User::find($f->formateur_id);
													 ?>
													<tr>
														<td><img src="../<?=$f->img?>" width="32" height="32"
														...
														<td><button type="button" class="btn btn-warning"
																...
																data-bs-target="#ModifierFormation<?=$f->id?>">Modifier
															</button>  <a href="../../controllers/adminController.php?a=supprimerFormation&id=<?=$f->id?>" class="btn btn-danger">
																Supprimer
															</a></td>

													</tr>

													<div class="modal fade" id="ModifierFormation<?=$f->id?>" tabindex="-1" role="dialog" aria-hidden="true">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body m-3">
																		<form method="POST" action="../../controllers/adminController.php?a=modifierFormation">
																			<div class="row">
																						...
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									...
																									<input value="<?=$f->titre?>" name="titre" type="text"
																							...
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									...
																									<textarea  name="description" rows="20"
																										class="form-control formControlMedium rounded-sm d-block w-100"><?=$f->description?></textarea>
																								</label>
																							</div>
																						</div>
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Date de début <span
																											class="text-brown">*</span></strong>
																									<input value="<?=$f->dateDebut?>" name="dateDebut" type="date"
																										class="form-control formControlMedium rounded-sm d-block w-100">
																								</label>
																							</div>
																						</div>
																							...
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Date de fin <span
																											class="text-brown">*</span></strong>
																									<input value="<?=$f->dateFin?>" name="dateFin" type="date"
																										class="form-control formControlMedium rounded-sm d-block w-100">
																								</label>
																							</div>
																						</div>
