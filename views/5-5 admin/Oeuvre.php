...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Oeuvre" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Oeuvre.php">Liste des
									Oeuvres</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Oeuvres</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success" onclick="window.location.href='Add-Oeuvre.php';">Ajouter Oeuvres
										</button>
										...
										<div class="table-responsive" style="width:100%">
											<table class="table table-striped">
												...
												<tbody>
													...
													<tr>
														<td><img src="../<?=$o->image?>" width="50" height="50"
														...
														<td><button type="button" class="btn btn-warning"
																...
																data-bs-target="#ModifierOeuvres">Modifier
															</button>  <a href="../../controllers/oeuvreController.php?a=supprimer&id=<?=$o->id?>" class="btn btn-danger">
																Supprimer
															</a></td>
	...
	<div class="modal fade" id="ModifierOeuvres" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modifier Oeuvre</h5>
						...
						<div class="row">
							<div class="col-12 col-md-12 px-xl-4">
								<div class="col-12 col-sm-12 px-2">
									<strong class="font-weight-normal d-block mb-1 form-label">Artiste
										<span class="text-brown">*</span></strong>
									<select disabled class="form-select" id="validationCustom04">
								...
								<div class="col-12 px-2">
									<div class="form-group position-relative mb-2">
										<div class="d-block">
											<strong class="font-weight-normal d-block mb-1">Histoire <span
													class="text-brown">*</span></strong>
											<input type="text"
												class="form-control formControlMedium rounded-sm d-block w-100">
								...
								<div class="col-12 px-2">
									<div class="form-group position-relative mb-2">
										<div class="d-block">
											<strong class="font-weight-normal d-block mb-1">Image <span
													class="text-brown">*</span></strong>
	...
	<div class="modal fade" id="SupprimerOeuvres" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Supprimer Oeuvre</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body m-3">
					<p class="mb-0">Voulez-vous Supprimer cet Oeuvre</p>
				</div>
				<div class="modal-footer">
