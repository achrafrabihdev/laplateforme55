				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Oeuvre" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Add-Oeuvre.php">Ajouter un
									Oeuvre</a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter un Oeuvre</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Information sur l'oeuvre</h5>
                                </div>
                                <div class="card-body">
									<form action="#">
										<div class="row">
													...
													<div class="col-12 px-2">
														<div class="form-group position-relative mb-2">
															<div class="d-block">
																...
																<input type="file" class="form-control formControlMedium rounded-sm d-block w-100">
