				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Evenement" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Add-Evenement.php">Ajouter un
									Evenement</a></li>
		...
		<div class="main">
			...
			<main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter un événement</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Information sur l'événement</h5>
                                </div>
                                <div class="card-body">
								<form method="POST" action="../../controllers/adminController.php?a=createEvenement" enctype="multipart/form-data">
										<div class="row">
											<div class="col-12 col-md-12 px-xl-4">
												<div class="form-row mx-n2">
													...
													<div class="form-group position-relative mb-2">
															<label class="d-block">
																<strong class="font-weight-normal d-block mb-1">Artiste <span
																		class="text-brown">*</span></strong>
																		<select name="user_id" class="form-control" id="exampleFormControlSelect1">
																		<option disabled >Choisissez l'artiste</option>
													...
													<div class="col-12 px-2">
														<div class="form-group position-relative mb-2">
															<label class="d-block">
																<strong class="font-weight-normal d-block mb-1">Date de debut</strong>
												...
												<div class="col-12 col-sm-12 px-2">
													...
													<div class="col-12  px-2">
                                                        ...
                                                        <button
                                                            class="btn btn-primary text-uppercase px-5">Soumettre ma
                                                            demande</button>
                                                    </div>
												</div>
											</div>
