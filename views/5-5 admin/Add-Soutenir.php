				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Soutenir" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Add-Soutenir.php">Ajouter un
									Soutenir</a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter un soutenant</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Information sur le soutenu</h5>
                                </div>
                                <div class="card-body">
									<form action="#">
										<div class="row">
											<div class="col-12 col-md-12 px-xl-4">
													...
													<select class="form-select formControlMedium rounded-sm d-block w-100" id="validationCustom04" required>
													...
													<div class="col-12 px-2">
														<div class="form-group position-relative mb-2">
															<label class="d-block">
																<strong class="font-weight-normal d-block mb-1">Montant soutenu <span class="text-brown">*</span></strong>
