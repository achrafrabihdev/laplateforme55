				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Evenement" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Evenement.php">Liste des
									Evenement</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Evenements</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success" onclick="window.location.href='Add-Evenement.php';">Ajouter Evenement
										</button>
									...
									<div class="card-body">
										<div class="table-responsive" style="width:100%">
											...
											<tbody>
												...
												<tr>
													<td><img src="../<?=$e->img?>" width="50" height="50"
													...
													<td><button type="button" class="btn btn-warning"
															...
															data-bs-target="#ModifierEvenement<?=$e->id?>">Modifier
														</button>  <a href="../../controllers/evenementController.php?a=suppriler&id=<?=$e->id?>" class="btn btn-danger">
															Supprimer
														</a></td>

												</tr>
												
												<div class="modal fade" id="ModifierEvenement<?=$e->id?>" tabindex="-1" role="dialog" aria-hidden="true">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body m-3">
																		<form method="POST" action="../../controllers/adminController.php?a=modifierEvenement">
																			<div class="row">
																				<div class="col-12 col-md-12 px-xl-4">
																					<h2 class="mb-5">Information sur l'evenement</h2>
																					<div class="form-row mx-n2">
																					<input type="hidden" name="id" value="<?=$e->id?>">
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Titre <span
																											class="text-brown">*</span></strong>
																									<input value="<?=$e->titre?>" name="titre" type="text"
																						...
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Evenement pour <span class="text-brown">*</span></strong>
																									<select name="type" class="form-control formControlMedium rounded-sm d-block w-100">
																										<option value="1" <?=($e->type == 1)?'selected':''?>>Public</option>
																										<option value="2" <?=($e->type == 2)?'selected':''?>>Artistes</option>
																									</select>
																								</label>
																							</div>
																						</div>
																						<div class="col-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Description<span
																											class="text-brown">*</span></strong>
																									<textarea  name="description" rows="20"
																										class="form-control formControlMedium rounded-sm d-block w-100"><?=$e->description?></textarea>
																								</label>
																							</div>
																						</div>
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Date de début <span
																											class="text-brown">*</span></strong>
																									<input value="<?=$e->dateDebut?>" name="dateDebut" type="date"
																										class="form-control formControlMedium rounded-sm d-block w-100">
																								</label>
																							</div>
																						</div>
																						<div class="col-12 col-sm-12 px-2">
																							<div class="form-group position-relative mb-2">
																								<label class="d-block">
																									<strong class="font-weight-normal d-block mb-1">Date de fin <span
																											class="text-brown">*</span></strong>
																									<input value="<?=$e->dateFin?>" name="dateFin" type="date"
																										class="form-control formControlMedium rounded-sm d-block w-100">
																								</label>
																							</div>
																						</div>
