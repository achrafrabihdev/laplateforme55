                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item ">
                        ...
                        <ul id="Article" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item "><a class="sidebar-link" href="Article.php">Liste des
                                    Article</a>
                    ...
                    <li class="sidebar-item active">
                        ...
                        <ul id="Project" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item active"><a class="sidebar-link" href="Add-Project.php">Ajouter un
                                    Project</a></li>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter un projet</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Information sur le projet</h5>
                                </div>
                                <div class="card-body">
                                    <form action="#">
                                        <div class="row">
                                            <div class="col-12 col-md-12 px-xl-4">
                                                <div class="form-row mx-n2">
                                                    ...
                                                    <div class="col-12  px-2">
                                                        ...
                                                        <a href="Mercipourvotredemande.php"
