                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="list-group list-group-flush" role="tablist">
                                    <a class="list-group-item list-group-item-action active" data-bs-toggle="list"
                                        href="#slider" role="tab">
                                        Slider
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list"
                                        href="#categorie" role="tab">
                                        Catégorie
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list"
                                        href="#DernierOeuvre" role="tab">
                                        Dernières Œuvres d'artistes
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#DerniersArtistes"
                                        role="tab">
                                        Dernièrs Artistes
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#DernierProject"
                                        role="tab">
                                        Derniers projets d’artistes
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#collection"
                                        role="tab">
                                        Collection
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#evenement"
                                        role="tab">
                                        Evénements à venir
                                    </a>
                                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#enchere"
                                        role="tab">
                        ...
                        <div class="col-md-9 col-xl-10">
                            <div class="tab-content">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Bouton">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="categorie" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form>
                                                <div class="mb-3">
                                                    <label class="form-label">Titre du catégorie</label>
                                ...
                                <div class="tab-pane fade" id="DernierOeuvre" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Dernières Œuvres d'artistes</h5>
                                           
                                            <form>
                                                <div class="col-md-3">
                                                    <label for="validationCustom04" class="form-label">Artiste</label>
                                                    <select class="form-select" id="validationCustom04" required>
                                                        <option selected disabled value="">Choisissez l'artiste</option>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="validationCustom04" class="form-label">Artiste</label>
                                                    <select class="form-select" id="validationCustom04" required>
                                                        <option selected disabled value="">Choisissez L'oeuvre l'artiste
                                                        </option>
                                                        <option>L’Adieu 2020</option>
                                                        <option>L’Adieu 2021</option>
                                                        <option>L’Adieu 2022</option>
                                                        <option>L’Adieu 2023</option>
        
                                                    </select>
                                                    <div class="invalid-feedback">
                                                        Veuillez sélectionner l'oeuvre de l'artiste valide. 
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="DerniersArtistes" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 class="card-title">Dernièrs Artistes</h3>

                                            <form>
                                                <div class="col-md-6">
                                                    <select multiple class="form-select" id="validationCustom04" required>
                                                        <option selected disabled value="">Choisissez l'artiste</option>
                                                        <option>RIDA BENHARROU</option>
                                                        <option>JOURNO Store</option>
                                                        <option>Mohammed ARRHIOUI</option>
                                ...
                                <div class="tab-pane fade" id="DernierProject" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Derniers projets d’artistes</h5>
                                            ...
                                            <form>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="validationCustom04" class="form-label">Artiste</label>
                                                    <select class="form-select" id="validationCustom04" required>
                                                        <option selected disabled value="">Choisissez Le projets d’artiste
                                                        </option>
                                                        <option>L’Adieu 2020</option>
                                                        <option>L’Adieu 2021</option>
                                                        <option>L’Adieu 2022</option>
                                ...
                                <div class="tab-pane fade" id="collection" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form>
                                                <div class="mb-3">
                                                    <label class="form-label">Titre du  Collection</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="validationCustom04" class="form-label">Artiste</label>
                                ...
                                <div class="tab-pane fade" id="evenement" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="validationCustom04" class="form-label">Titre de l'événement</label>
                                                    <select class="form-select" id="validationCustom04" required>
                                                        <option selected disabled value="">Choisissez un événement</option>
                                                        <option>Rough Cut: Independent Japanese Antiquity</option>
                                                        <option>Rojo Y Negro Latin American Art</option>
                                                        <option>Naive Painting Of The 19th Century</option>
                                                        <option>Adam Green Cartoon and Complaint</option>

                                                    </select>
                                                    <div class="invalid-feedback">
                                                        Veuillez sélectionner un événement valide.
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="enchere" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Les Enchères</h5>

                                            <form action="../../controllers/adminController.php?a=encherestatus" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="col-sm-10">
                                                            <label class="form-check">
                                                                <input name="enchere" type="radio" class="form-check-input"  value="activer" <?=($e->active==1)?'checked':''?>>
                                                                <span class="form-check-label">Activer les enchères<span>
                                                            </label>
                                                            <label class="form-check">
                                                                <input name="enchere" type="radio" class="form-check-input" value="desactiver" <?=($e->active==0)?'checked':''?>>
                                                                <span class="form-check-label">Désactiver les enchères</span>
                                                            </label>
