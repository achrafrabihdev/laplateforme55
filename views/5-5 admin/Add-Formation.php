				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Formation" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Add-Formation.php">Ajouter un
									Formation</a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter une formation</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Information sur la formation</h5>
                                </div>
                                <div class="card-body">
									<form method="POST" action="../../controllers/adminController.php?a=createFormation" enctype="multipart/form-data">
										<div class="row">
											<div class="col-12 col-md-12 px-xl-4">
												<div class="form-row mx-n2">
													...
													<div class="form-group position-relative mb-2">
															<label class="d-block">
																<strong class="font-weight-normal d-block mb-1">Formateur <span
																		class="text-brown">*</span></strong>
																		<select name="formateur_id" class="form-control" id="exampleFormControlSelect1">
																		<option disabled >Choisissez le formateur</option>
