...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Soutenir" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Soutenir.php">Liste des
									Soutenant</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Soutenants</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success" onclick="window.location.href='Add-Soutenir.php';">Ajouter Soutenant
										</button>
											...
											<table class="table table-striped">
												...
												<tbody>
													<tr>
														...
														<td>Rida Benharrou</td>
														<td>3000 MAD</td>
														<td><span class="badge bg-success">Active</span></td>

														<td><button type="button" class="btn btn-warning"
																data-bs-toggle="modal"
																data-bs-target="#ModifierSoutenant">Modifier
															</button> / <button type="button" class="btn btn-danger"
																data-bs-toggle="modal"
																data-bs-target="#SupprimerSoutenant">
																Supprimer
															</button></td>
	...
	<div class="modal fade" id="ModifierSoutenant" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modifier Soutenant</h5>
							...
							<div class="col-12 col-md-12 px-xl-4">
								...
								<div class="col-12 px-2">
									<div class="form-group position-relative mb-2">
										<label class="d-block">
											<strong class="font-weight-normal d-block mb-1">Nom</strong>
											<input type="text"
								...
								<div class="col-12 col-sm-12 px-2">
									...
									<select class="form-select formControlMedium rounded-sm d-block w-100"
								...
								<div class="col-12 px-2">
									<div class="form-group position-relative mb-2">
										<label class="d-block">
											<strong class="font-weight-normal d-block mb-1">Montant soutenu <span
	...
	<div class="modal fade" id="SupprimerSoutenant" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Supprimer Soutenant</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body m-3">
					<p class="mb-0">Voulez-vous Supprimer cet Soutenant</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
