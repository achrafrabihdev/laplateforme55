...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="Project" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="Project.php">Liste des
									Projects</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Projects</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success" onclick="window.location.href='Add-Project.php';">Ajouter Project
										</button>
									...
									<div class="card-body">
										<div class="table-responsive" style="width:100%">
											<table class="table table-striped">
												...
												<tbody>
													<tr>
														<td><img src="img/avatars/avatar.jpg" width="50" height="50"
																class="my-n1" alt="Avatar"></td>
														<td><img src="img/avatars/avatar-2.jpg" width="50" height="50"
																class="my-n1" alt="Avatar"></td>
														<td>01/01/2021</td>
														<td>Good Guys</td>
														<td>Lorem ipsum dolor sit amet consectetur adipisicing elit.
															Aliquid fugit labore maiores at itaque, commodi, similique
															deserunt error sint pariatur dignissimos. Ad amet tempore
															esse vitae sunt odio doloribus voluptates!</td>
														<td>3000 MAD</td>

														<td><button type="button" class="btn btn-warning"
																data-bs-toggle="modal"
																data-bs-target="#ModifierProject">Modifier
															</button> / <button type="button" class="btn btn-danger"
																data-bs-toggle="modal"
																data-bs-target="#SupprimerProject">
																Supprimer
															</button></td>
	...
	<div class="modal fade" id="ModifierProject" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modifier Project</h5>
							...
							<div class="col-12 col-md-12">
								<div class="form-row mx-n2">
									...
									<div class="col-12 col-sm-12">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												<strong class="font-weight-normal d-block mb-1">Montant dont L'artiste a
													besoin <span class="text-brown">*</span></strong>
												<input type="number"
													class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									...
									<div class="col-12 col-sm-12">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												<strong class="font-weight-normal d-block mb-1">Image du projet<span
														class="text-brown">*</span></strong>
												<input type="file"
													class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
									...
									<div class="col-12 col-sm-12">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												<strong class="font-weight-normal d-block mb-1">Affiche du projet<span
														class="text-brown">*</span></strong>
												<input type="file"
													class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
									...
									<div class="col-12 ">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												<strong class="font-weight-normal d-block mb-1">Description du
	...
	<div class="modal fade" id="SupprimerProject" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Supprimer Project</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body m-3">
					<p class="mb-0">Voulez-vous Supprimer cet Project</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
