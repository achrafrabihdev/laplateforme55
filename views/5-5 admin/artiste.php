...
<body data-theme="default" data-layout="fluid" data-sidebar="left">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="artiste" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="artiste.php">Liste des
									artistes</a>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des Artistes</h1>
					</div>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-actions float-end">
										<button type="button" class="btn btn-success"onclick="window.location.href='Add-artiste.php';">Ajouter Artiste
										</button>
											...
											<table class="table table-striped">
												<thead>
													<tr>
														...
														<th>Nom</th>
														<th>Email</th>
														<th>Artiste interne</th>
														<th>Artiste donateur</th>
														<th>Status</th>
														<th>Action</th>
												...
												<tbody>
													...
													<tr>
														...
														<td><?=$a->nom?></td>
														<td><?=$a->email?></td>
														<td><?=($a->artiste_interne == 1)?'oui':'non'?></td>
														<td><?=($a->artiste_donateur == 1)?'oui':'non'?></td>
														<td><span class="badge bg-success">Active</span></td>

														<td><button type="button" class="btn btn-warning"
																data-bs-toggle="modal"
																data-bs-target="#ModifierArtiste">Modifier
															</button>  <a type="button" class="btn btn-danger"
																href="../../controllers/userController.php?a=supprimer&id=<?=$a->id?>">
																Supprimer
															</a></td>
	...
	<div class="modal fade" id="ModifierArtiste" tabindex="-1" role="dialog" aria-hidden="true">
					...
					<div class="row">
						<div class="col-12 col-xl-12">
							...
							<form>
								...
								<div class="mb-3">
									<strong class="font-weight-normal d-block mb-1 form-label">Catégorie
										<span class="text-brown">*</span></strong>
									<select class="form-select" id="validationCustom04" required>
										<option selected disabled value="">Choisissez la catégorie</option>
								...
								<div class="mb-3">
									<label class="form-label">Biographie de l'artiste</label>
									<textarea class="form-control" placeholder="Textarea" rows="3"></textarea>
								</div>
								<div class="mb-3">
									<label class="form-label w-100">Portfolio</label>
									<input type="file" class="form-control" multiple>
								</div>
								<div class="mb-3">
									<strong class="font-weight-normal d-block mb-1 form-label">Formation
										<span class="text-brown">*</span></strong>
									<select class="form-select" id="validationCustom04" required>
										<option selected disabled value="">Choisissez la formation</option>
										<option>Lauréat INBA Tétouan</option>
										<option>Lauréat ESBA Casablanca</option>
										<option>Autodidacte</option>
										<option>Formation 04</option>
		...
		<div class="modal fade" id="SupprimerArtiste" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Supprimer Artiste</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body m-3">
						<p class="mb-0">Voulez-vous Supprimer cet Artiste</p>
					</div>
					<div class="modal-footer">
