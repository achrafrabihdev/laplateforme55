					...
					<div class="tab-content">
						...
						<div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="current-tab">
							...
							<div class="row makeItMasonery mx-xl-n4">
								...
								<div class="col-12 col-sm-6 col-md-4 mimItem px-xl-4">
									...
									<article class="collectionColumn mb-6 mb-xl-8 text-center position-relative">
										<div class="imgHolder">
											<a href="detailoeuvre.php?id=<?=$o->id?>">
												<img src="<?=$o->image?>" class="img-fluid w-100 d-block" alt="image description">
												<div class="ccCaption position-absolute bg-white d-flex align-items-center justify-content-center">
													<div class="w-100 py-3 px-3">
														<h2 class="fzMedium mb-4"><?=$o->nom?></h2>
														<h3 class="fontAlter text-gray777 mb-0"><?=$o->hauteur?>CM x <?=$o->largeur?>CM x <?=$o->epaisseur?>CM</h3>
													</div>
												</div>
											</a>
										</div>
							...
							<div class="btnHolder text-center pt-6">
								<a href="single-works.html" class="btn laodMore btn-outline-light bdr2 btnMidMinWidth">Load More</a>
							</div>
						</div>
					</div>
				</div>
