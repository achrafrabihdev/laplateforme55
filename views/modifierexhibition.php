					...
					<header class="topHeadingHead text-center mb-lg-7 mb-xl-9">
						<div class="row">
							<div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
								<h1 class="h1Large mb-4"> Modifier une exhibition</h1>
							</div>
						</div>
					</header>
					<!-- alert -->
...
-->
					<form action="../controllers/exhibitionController.php?a=modifier&id=<?=$id?>" method="POST" enctype="multipart/form-data">
									...
									<div class="col-12 col-sm-12 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="text" value="<?=$ex->titre?>" name="titre" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
                                    <div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="text" value="<?=$ex->lieu?>" name="lieu" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="text" value="<?=$ex->theme?>" name="theme" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
									<div class="col-12 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
                                                ...
                                                <textarea rows="20" name="description" class="form-control formControlMedium rounded-sm d-block w-100"><?=$ex->description?></textarea>
											</label>
										</div>
									</div>
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="date" value="<?=$ex->dateDebut?>" name="dateDebut" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
									<div class="col-12 col-sm-6 px-2">
										<div class="form-group position-relative mb-2">
											<label class="d-block">
												...
												<input type="date" value="<?=$ex->dateFin?>" name="dateFin" class="form-control formControlMedium rounded-sm d-block w-100">
											</label>
										</div>
									</div>
